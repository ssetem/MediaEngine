(function() {
  var FileUtils, Step, fs, mime, mkdirp, path, util;
  util = require("util");
  fs = require("fs");
  path = require("path");
  ...
  FileUtils = {
    ...
    writeFile: function(filePath, contents, fn) {
      return fs.writeFile(filePath, contents, fn);
    },
    ...
    identifyFileMimeType: function(fileLocation, fn) {
      return fn(mime.lookup(fileLocation));
    },

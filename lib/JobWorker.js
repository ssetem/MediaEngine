(function() {
  var AbstractJobManager, ImageMagickProcessor, JobContext, JobFlowManager, JobWorker, MetadataImageProcessor, UppercaseProcessor, VideoProcessor, ZipProcessor, async, fs, _;
  ...
  JobWorker = (function() {
    ...
    function JobWorker(options) {
      ...
      this.processClass = UppercaseProcessor;
